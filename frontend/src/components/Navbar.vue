<template>
  <aside :class="{ 'is-expanded': is_expanded }" class="flex flex-col w-[calc(2rem+32px)] min-h-[100vh] overflow-hidden p-4 bg-bluegrey ease-out duration-200">
    ...
    <div class="navigation my-0 -mx-4 z-10">
      ...
      <router-link :class="['button ', { 'text-lightgreen bg-red': currentPage === '/adminAlbums' }]" to="/adminAlbums">
        ...
        <span class="text" :class="['text-lightgrey font-semibold text-lg',{ 'text-lightgreen': currentPage === '/adminAlbums' }]">Albums</span>
      </router-link>
